...
const Google = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <g clipPath="url(#a)">
      <path
        fill="#4285F4"
        d="M19.787 10.225c0-.658-.058-1.283-.158-1.892h-9.417v3.759h5.392c-.242 1.233-.95 2.275-2 2.983v2.5h3.217c1.883-1.742 2.966-4.308 2.966-7.35Z"
      />
      <path
        fill="#34A853"
        d="M10.213 20c2.7 0 4.958-.9 6.608-2.425l-3.217-2.5c-.9.6-2.041.967-3.391.967-2.609 0-4.817-1.759-5.609-4.134H1.288v2.575C2.929 17.75 6.304 20 10.213 20Z"
      />
      <path
        fill="#FBBC05"
